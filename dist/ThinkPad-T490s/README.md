...
8. **Services Demand-Start & Telemetry Debloat**: Non-essential services (`MapsBroker`, `WerSvc`, `RetailDemo`, `DiagTrack`, and crashing `QianwenUpdater` services eliminating Event 7024 errors) converted to Manual (Demand-Start) to guarantee 0% idle CPU waste.
