...
* **Linux (Fedora / Debian)**: Download [**`ThinkPad-T490s-Linux-Autonomous-v1.2.1.zip`**](https://github.com/ShoumikBalaSomu/Device-Base-Optimization/releases/download/v1.2.1/ThinkPad-T490s-Linux-Autonomous-v1.2.1.zip) and run `run-once.sh`.
