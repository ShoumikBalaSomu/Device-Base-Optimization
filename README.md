...
* **ThinkPad T490s Linux**: Download [**`ThinkPad-T490s-Linux-Autonomous-v1.2.3.zip`**](https://github.com/ShoumikBalaSomu/Device-Base-Optimization/releases/download/v1.2.3/ThinkPad-T490s-Linux-Autonomous-v1.2.3.zip) and run `run-once.sh`.
