...
You only need to run this once. It optimizes all 10 hardware and kernel sectors, locks the 75%-80% battery threshold, and installs a persistent background watchdog service that automatically switches between Maximum Performance on AC and Extreme Battery Saver on Battery.
